            ...
            <form class="form-horizontal" action="/groupcreate" method="POST">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="group_name" name="group_name" required="true" placeholder="" class="form-control input-lg">
                            <p class="help-block">You group name can be whatever you'd like it to be</p>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="join_by_request">Make Group Public</label>
                        <div class="controls">
                            <input type="checkbox" id="join_by_request" name="join_by_request" required="true" class="form-control input-lg" >
                            <p class="help-block">Making your group public will allow anyone to join as long as the max size is not met. A private group will require you to approve user request</p>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="group_description" name="group_description" required="false" placeholder="Provide a description about your groups goals and purpose." class="form-control input-lg">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="course_id" name="course_id" required="true" placeholder="" class="form-control input-lg">
                            <p class="help-block">The course number. Example EE461S or M360L</p>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="course_name" name="course_name" required="true" placeholder="" class="form-control input-lg">
                            <p class="help-block">The name of the course that you are creating this group for. Example Vector Calculus</p>
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label" for="professor">Course Professor</label>
                        <div class="controls">
                            <input type="text" id="professor" name="professor" required="false" placeholder="" class="form-control input-lg">
                            <p class="help-block"></p>
                        </div>
                    </div>
